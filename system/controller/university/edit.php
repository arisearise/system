...
isset($_REQUEST['customer_id']    ) ? $para['customer_id']     = intval($_REQUEST['customer_id']    ) : $para['customer_id']     = null;
isset($_REQUEST['customer_name']  ) ? $para['customer_name']   =        $_REQUEST['customer_name']    : $para['customer_name']   = '';
...
if ($para['init'] === '') {
    $customerList = $m->getCustomerListById($para['customer_id']);
	isset($customerList['customer_name'])   ? $para['customer_name']   = $customerList['customer_name']   : $para['customer_name']   = '';
